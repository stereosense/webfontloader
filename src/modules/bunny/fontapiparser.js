goog.provide('webfont.modules.bunny.FontApiParser');
 ...
 * @constructor
 */
webfont.modules.bunny.FontApiParser = function(fontFamilies) {
  this.fontFamilies_ = fontFamilies;
  this.parsedFonts_ = [];
  this.fontTestStrings_ = {};
};

webfont.modules.bunny.FontApiParser.INT_FONTS = {
...
webfont.modules.bunny.FontApiParser.WEIGHTS = {
  'thin': '1',
  'extralight': '2',
  'extra-light': '2',
  'ultralight': '2',
...
webfont.modules.bunny.FontApiParser.STYLES = {
  'i': 'i',
  'italic': 'i',
  'n': 'n',
  'normal': 'n'
