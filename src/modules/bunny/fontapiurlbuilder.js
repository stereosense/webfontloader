goog.provide('webfont.modules.bunny.FontApiUrlBuilder');

/**
 * @constructor
 */
webfont.modules.bunny.FontApiUrlBuilder = function(apiUrl, text) {
  if (apiUrl) {
    this.apiUrl_ = apiUrl;
  } else {
    this.apiUrl_ = webfont.modules.bunny.FontApiUrlBuilder.DEFAULT_API_URL;
  }
  this.fontFamilies_ = [];
  this.subsets_ = [];
  this.text_ = text || '';
...
webfont.modules.bunny.FontApiUrlBuilder.DEFAULT_API_URL = 'https://fonts.bunny.net/css';

goog.scope(function () {
  var FontApiUrlBuilder = webfont.modules.bunny.FontApiUrlBuilder;
